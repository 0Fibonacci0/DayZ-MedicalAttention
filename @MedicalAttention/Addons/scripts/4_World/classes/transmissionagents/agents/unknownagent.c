class UnknownToxineAgent: AgentBase
{
	override void Init()
	{
		m_Type 					= MedicalAttentionAgents.UNKNOWN_TOXINE;
		...
		m_DieOffSpeed = 0.278;//how fast the agent dies off when not potent enough to grow(per sec)
	}
}